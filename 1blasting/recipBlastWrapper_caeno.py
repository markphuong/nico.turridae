...
def align(element):
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/nico.turridae/0data/{sample}*.fasta ./
	...
	cp {sample}_assemblies_clustered.fasta.NI /pylon5/bi4s86p/phuong/nico.turridae/1blasting/
	cp {sample}.blastx /pylon5/bi4s86p/phuong/nico.turridae/1blasting/
	cp {sample}.tblastn /pylon5/bi4s86p/phuong/nico.turridae/1blasting/
	cp {sample}.filtered_results /pylon5/bi4s86p/phuong/nico.turridae/1blasting/
	cp {sample}_phylo_contigs.fa /pylon5/bi4s86p/phuong/nico.turridae/1blasting/
	""".format(**variables)
