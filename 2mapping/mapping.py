...
# some names for input output files
	...
	read1 = '/pylon2/bi4s86p/phuong/nico.turridae/fastq/' + ID + r1name,
	read2 = '/pylon2/bi4s86p/phuong/nico.turridae/fastq/' + ID + r2name,
	unpaired = '/pylon2/bi4s86p/phuong/nico.turridae/fastq/' + ID + uname,
...
# 10. create a VCF file
	...
	commands = """
	cp /pylon2/bi4s86p/phuong/nico.turridae/1blasting/{ref} ./
	...
	mv {sample}* /pylon2/bi4s86p/phuong/bait.design.2017/phylogenetics/1transcriptome.markers/1mapping
	""".format(**variables)
