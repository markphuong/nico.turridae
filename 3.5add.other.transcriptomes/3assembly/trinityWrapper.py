...
def align(element):
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/nico.turridae/13add.other.transcriptomes/2trim/{read1} ./
	cp /pylon5/bi4s86p/phuong/nico.turridae/13add.other.transcriptomes/2trim/{read2} ./
