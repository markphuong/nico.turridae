...
def concat(element):
	...
	commands = """
	/home/phuong/CAP3/cap3 {index}_trinity.Trinity.fasta > {index}.cap3.out
	cat {index}_trinity.Trinity.fasta.cap.contigs {index}_trinity.Trinity.fasta.cap.singlets > {index}_cap3.fasta
