...
def align(element):
	...
	""".format(**variables)
#	python concatenatedFile.py turridae_phylogeny_{threshold}.nexus
#	python trimmfile.py turridae_phylogeny_{threshold}.nexus turridae_phylogeny_headed_{threshold}.nexus
#	python nexus2phylip.py turridae_phylogeny_headed_{threshold}.nexus turridae_phylogeny_{threshold}.phylip
#	python countcompleteness.py turridae_phylogeny_headed_{threshold}.nexus turridae_phylogeny_headed_{threshold}.completeness
