...
# 10. create a VCF file
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/nico.turridae/fastq/{read1} ./
	cp /pylon5/bi4s86p/phuong/nico.turridae/fastq/{read2} ./
	cp /pylon5/bi4s86p/phuong/nico.turridae/fastq/{unpaired} ./
	cp /pylon5/bi4s86p/phuong/nico.turridae/0data/{ref} ./
	...
	cp {sample}.* /pylon5/bi4s86p/phuong/nico.turridae/mitodna/0mapping
	cp {sample}_* /pylon5/bi4s86p/phuong/nico.turridae/mitodna/0mapping
	""".format(**variables)
