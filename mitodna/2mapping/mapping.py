...
# some names for input output files
	...
	read1 = '/pylon5/bi4s86p/phuong/nico.turridae/fastq/' + ID + r1name,
	read2 = '/pylon5/bi4s86p/phuong/nico.turridae/fastq/' + ID + r2name,
	unpaired = '/pylon5/bi4s86p/phuong/nico.turridae/fastq/' + ID + uname,
...
# 10. create a VCF file
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/nico.turridae/mitodna/1blasting/{ref} ./
	...
	mv {sample}* /pylon5/bi4s86p/phuong/nico.turridae/mitodna/2mapping/
	""".format(**variables)
